  ...
  return (
    <footer className="bg-navy text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-sm text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://www.instagram.com/dynetinfratechniek"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-green transition-colors"
